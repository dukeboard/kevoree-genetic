...
public aspect trait GeneratedAspect_Epsilon : org.kevoree.modeling.optimization.executionmodel.Epsilon {
    override fun update() {
        var nbObjectives = 0
        ...
        value = org.kevoree.modeling.optimization.executionmodel.qualityIndicator.Epsilon.getINSTANCE()!!.epsilon(MetricsUtil.buildKMFGenTruePareto(nbObjectives),input,nbObjectives)
    }
}

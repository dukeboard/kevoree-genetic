...
public aspect trait GeneratedAspect_InvertedGenerationalDistance : org.kevoree.modeling.optimization.executionmodel.InvertedGenerationalDistance {
    override fun update() {
        var nbObjectives = 0
        ...
        value = org.kevoree.modeling.optimization.executionmodel.qualityIndicator.InvertedGenerationalDistance.getINSTANCE()!!.invertedGenerationalDistance(input,MetricsUtil.buildKMFGenTruePareto(nbObjectives),nbObjectives)
    }
}

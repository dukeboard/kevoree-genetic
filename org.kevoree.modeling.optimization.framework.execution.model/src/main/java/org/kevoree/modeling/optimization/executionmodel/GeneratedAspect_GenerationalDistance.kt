...
public aspect trait GeneratedAspect_GenerationalDistance : org.kevoree.modeling.optimization.executionmodel.GenerationalDistance {
    override fun update() {
        var nbObjectives = 0
        ...
        value = org.kevoree.modeling.optimization.executionmodel.qualityIndicator.GenerationalDistance.getINSTANCE()!!.generationalDistance(input,MetricsUtil.buildKMFGenTruePareto(nbObjectives),nbObjectives)
    }
}

    ...
    public Solution[] evolve(Solution[] parents) {
        ...
        try {
            if (mutator != null) {
                ...
                KMFContainer m = variable.getModel();
                KMFContainer afterMutation = mutator.mutate(m);
                Solution s = problem.newSolution();
                s.setVariable(0, new KevoreeVariable(afterMutation,variable.getModelCloner()).setOrigin(variable.getOrigin()));
            ...
            if (cross != null) {
                ...
                KMFContainer m2 = variable2.getModel();
                KMFContainer afterMutation = cross.cross(m, m2);
